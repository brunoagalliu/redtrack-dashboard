  ...
  try {
    ...
    for (const buyer of BUYERS) {
      ...
      newCampaigns[buyer] = {
        ...
        daily:      rows, // full period for sparkline
      };
    }
...
## 👤 KG — 💰 Best Combinations to Scale
KG campaigns ONLY. One row per profitable combo.
| Vertical/Offer | Route | Carrier | EPC | ROI | Conv | Action |
|---|---|---|---|---|---|---|

## 👤 KG — 🔴 Cut Immediately
KG losing combos ONLY. Every loser — no omissions.
| Vertical/Offer | Route | Carrier | Loss ($) | Action |
|---|---|---|---|---|

## 👤 KG — 🔁 Budget Reallocation
Budget moves KG specifically should make.
| From Vertical/Offer | From Route | From Carrier | To Vertical/Offer | To Route | To Carrier | Why |
|---|---|---|---|---|---|---|

## 👤 KG — 📡 Route & Carrier Intelligence
Which routes and carriers perform best/worst for KG's campaigns specifically.
| Type | Name | Avg EPC | Best Vertical | Trend | Note |
|---|---|---|---|---|---|

## 👤 KG — 🤝 Partner & Offer Analysis
KG's offers ranked by EPC and profitability.
| Offer | Partner | EPC | ROI | Verdict |
|---|---|---|---|---|
